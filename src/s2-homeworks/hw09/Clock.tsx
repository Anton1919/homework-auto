...
function Clock() {
	...
	const stringTime = `${date.getHours() < 10 || date.getHours() == 0 
			? `0${date.getHours()}` 
			: date.getHours()}:${date.getMinutes() < 10 || date.getMinutes() == 0 
			? `0${date.getMinutes()}` 
			: date.getMinutes()}:${date.getSeconds() < 10 || date.getSeconds() == 0 
			? `0${date.getSeconds()}` 
			: date.getSeconds()}` ||
